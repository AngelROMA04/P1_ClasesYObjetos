/*  CLASES Y OBJETOS
Rodriguez Martinez Angel Gabriel
Carvajal Martinez Dante Emanuel
*/
...
int main() {
    Empleado jefePlanta(1, "Juan", "Calle 123", 001, "Nadie");
    Empleado jefePersonal(2, "Pedro", "Calle 456", 002, "Juan");
    ...
    while (1) {
        ...
        default: std::cout << "Ingresa una opcion valida" << std::endl;
        }
    }
}